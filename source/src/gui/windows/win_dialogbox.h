...
public:
	...
	virtual void SetComboBoxItems(HWND combo, const CMsg::Id *list, int selnum, bool translate = false);
	virtual void SetComboBoxItems(int nItemId, const CMsg::Id *list, int selnum, bool translate = false);
	...
	virtual HWND CreateComboBox(CBox *box, int nItemId, const CMsg::Id *list, int selnum, int nMinSize, bool translate = false);
