...
protected:
	void find_fetch_break_trace_points(BreakPoints::en_break_point_type bp_type, uint32_t addr, int length, bool &suspended);
	void find_mem_break_trace_points(BreakPoints::en_break_point_type bp_type, uint32_t addr, int length, uint32_t value, bool &suspended);
	void find_io_break_trace_points(BreakPoints::en_break_point_type bp_type, uint32_t addr, int length, uint32_t value, bool &suspended);
	void find_intr_break_trace_points(BreakPoints::en_break_point_type bp_type, uint32_t addr, uint32_t mask, bool &suspended);
	void find_basic_break_trace_points(BreakPoints::en_break_point_type bp_type, DEVICE *d_mem, uint32_t addr, uint32_t data, bool &suspended);
