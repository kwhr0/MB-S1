...
public:
	...
	//@{
	bool open_disk_main(int drv, const _TCHAR* file_path, int offset, uint32_t flags);
...
#ifdef USE_AUTO_KEY
	virtual void parse_auto_key(const char *buf, int size, int &prev_code, int &prev_kana);
#endif
