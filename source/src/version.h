...
#define APP_NAME		"HITACHI MB-S1 model05 Emulator"
#define APP_FILENAME	"mbs1.exe"
#define APP_INTERNAME	"EmuB-S1"
#define APP_COPYRIGHT	"Copyright (C) 2011,2012-2021 Common Source Code Project, Sasaji"
#define APP_VERSION		"0.6.6.962"
#define APP_VER_MAJOR	0
#define APP_VER_MINOR	6
#define APP_VER_REV		6
#define APP_VER_BUILD	962
