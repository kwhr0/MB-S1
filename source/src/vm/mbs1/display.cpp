...
//		logging->out_debugf("dispw a:%04x d:%02x",addr,data);
	...
	case 0xffd0:
		...
		d_crtc->write_signal(SIG_HD46505_CHR_CLOCKS, CLOCKS_1MHZ * (NOW_S1_MODE || (mode_sel & 0x80) ? 2 : 1), 0xffffffff);
...
void DISPLAY::update_vram(int v, int clock)
{
...
void DISPLAY::load_state(FILEIO *fio)
{
