...
#define SIG_BOARD_WRESET_RELEASE 1
#define SIG_BOARD_PRESET_RELEASE 2
...
#pragma pack(1)
	struct vm_state_st {
		...
		uint8_t	sys_mode; 			///< after process power on
		uint8_t	exram_size_num; 	///< after process power on
		char    reserved1;
