...
#define SIG_DISPLAY_LPSTB	1
#define SIG_DISPLAY_CHR_CLOCKS	2
#define SIG_DISPLAY_VSYNC	3
#define SIG_DISPLAY_HSYNC	4
#define SIG_DISPLAY_DISPTMG	5
#define SIG_DISPLAY_WRITE_REGS	6
...
public:
	...
	void event_frame();
	void update_vram(int v, int clock);
