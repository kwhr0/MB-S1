...
#define SIG_ACIA_RXCLK	3
#define SIG_ACIA_TXCLK	4

#define SIG_ACIA_RXDATA	5
#define SIG_ACIA_TXDATA	6

#define SIG_ACIA_DTR	7	// Data Terminal Ready
#define SIG_ACIA_RTS	8	// Request To Send

#define SIG_ACIA_CTS	9	// Clear To Send
#define SIG_ACIA_DCD	10	// Data Carrier Detect

#define SIG_ACIA_ERROR		12
#define SIG_ACIA_ERR_OVRN	13
#define SIG_ACIA_RESET		14

#define SIG_ACIA_CR		15	// read control register
#define SIG_ACIA_SR		16	// read status register
