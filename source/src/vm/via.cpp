...
#define EVENT_VIA_CA2	1
#define EVENT_VIA_CB2	2
#define EVENT_VIA_TIMER1	3
#define EVENT_VIA_TIMER2	4
#define EVENT_VIA_SHIFT2_LOW	5
#define EVENT_VIA_SHIFT2_HIGH	6
#define EVENT_VIA_SHIFT2_INTR	7
...
{
	buffer[0] = _T('\0');
	UTILITY::sntprintf(buffer, buffer_len, _T(" %X(%s):%02X"), 0, _T("IRB/ORB"), drb);
	UTILITY::sntprintf(buffer, buffer_len, _T(" %X(%s):%02X"), 1, _T("IRA/ORA"), dra);
	UTILITY::sntprintf(buffer, buffer_len, _T(" %X(%s):%02X"), 2, _T("DDRB"), ddrb);
	UTILITY::sntprintf(buffer, buffer_len, _T(" %X(%s):%02X"), 3, _T("DDRA"), ddra);
	UTILITY::tcscat(buffer, buffer_len, _T("\n"));
	UTILITY::sntprintf(buffer, buffer_len, _T(" %X(%s):%04X"), 4, _T("T1L"), t1l);
	UTILITY::sntprintf(buffer, buffer_len, _T(" %X(%s):%04X"), 5, _T("T1C"), t1c);
	UTILITY::sntprintf(buffer, buffer_len, _T(" %X(%s):%04X"), 6, _T("T2L"), t2l);
	UTILITY::sntprintf(buffer, buffer_len, _T(" %X(%s):%04X"), 7, _T("T2C"), t2c);
	UTILITY::tcscat(buffer, buffer_len, _T("\n"));
	UTILITY::sntprintf(buffer, buffer_len, _T(" %X(%s):%02X"), 8, _T("SR"), sr);
	UTILITY::sntprintf(buffer, buffer_len, _T(" %X(%s):%02X"), 9, _T("ACR"), acr);
	UTILITY::sntprintf(buffer, buffer_len, _T(" %X(%s):%02X"), 10, _T("PCR"), pcr);
	UTILITY::sntprintf(buffer, buffer_len, _T(" %X(%s):%02X"), 11, _T("IFR"), ifr);
	UTILITY::sntprintf(buffer, buffer_len, _T(" %X(%s):%02X"), 12, _T("IER"), ier);
}
